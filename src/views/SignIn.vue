...
async function submit() {
  ...
  try {
    ...
    error.value = mapAuthError(e.code) || e.message;
  } finally {
  ...
  >
    ...
    >
      <div class="text-center">
        ...
        <h2 class="mt-2 text-xl font-medium text-gray-600">Welcome Back</h2>
        <p class="mt-2 text-sm text-gray-500">
          Sign in to access your account and explore the latest trends.
        </p>
      </div>
